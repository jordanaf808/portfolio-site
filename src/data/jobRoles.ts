...
export const jobRoles: JobRole[] = [
	...
	},
	{
		...
		images: [{ src: atitlanBootPicker }, { src: commandCoffee }, { src: stazeCustomTrio }],
		featured: true,
	},
	{
		type: 'jobRole',
		...
		images: [{ src: stazeHomepage }, { src: stazeProductDetails }],
		featured: false,
	},
	{
		type: 'jobRole',
		...
		images: [{ src: simplehumanConfig }, { src: simplehumanPersonalization }],
		featured: true,
	},
	{
		type: 'jobRole',
