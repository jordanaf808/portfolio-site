...
[🚧] - Get icons for tech labels (see marigiland project)
...
[🚧] - Allow paragraphs in overview/description when text contains `\n\n`, is there a better way to do this?.
...
Make a script or program that prompts me to tell it what I'm working on right now. I would like it to keep track of what I'm working on and how long I'm working.
